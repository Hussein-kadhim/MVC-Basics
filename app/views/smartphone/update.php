        ...
        <div class="col-6">
            <form action="<?= URLROOT; ?>/SmartphoneController/update" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input name="merk" type="text" class="form-control <?= isset($data['errors']['merk']) ? 'is-invalid' : ''; ?>" id="merk"
                ...
                <div class="mb-3">
                    ...
                    <input name="prijs" type="number" step="0.01" class="form-control <?= isset($data['errors']['prijs']) ? 'is-invalid' : ''; ?>" id="prijs"
                ...
                <div class="mb-3">
                    ...
                    <input name="geheugen" type="number" class="form-control <?= isset($data['errors']['geheugen']) ? 'is-invalid' : ''; ?>" id="geheugen"
                ...
                <div class="mb-3">
                    ...
                    <input name="besturingssysteem" type="text" class="form-control <?= isset($data['errors']['besturingssysteem']) ? 'is-invalid' : ''; ?>" id="besturingssysteem"
                ...
                <div class="mb-3">
                    ...
                    <input name="schermgrootte" type="number" step="0.01" class="form-control <?= isset($data['errors']['schermgrootte']) ? 'is-invalid' : ''; ?>"
                        id="schermgrootte" value="<?= $_POST['schermgrootte'] ?? $data['smartphone']->Schermgrootte; ?>">
                ...
                <div class="mb-3">
                    ...
                    <input name="megapixels" type="number" class="form-control <?= isset($data['errors']['megapixels']) ? 'is-invalid' : ''; ?>" id="megapixels"
