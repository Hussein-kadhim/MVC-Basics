        ...
        <div class="col-6">
            <form action="<?= URLROOT; ?>/SmartphoneController/create" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input name="prijs" type="number" step="0.01" class="form-control <?= isset($data['errors']['prijs']) ? 'is-invalid' : ''; ?>" id="prijs" value="<?= $_POST['prijs'] ?? ''; ?>">
                ...
                <div class="mb-3">
                    ...
                    <input name="geheugen" type="number" class="form-control <?= isset($data['errors']['geheugen']) ? 'is-invalid' : ''; ?>" id="geheugen" value="<?= $_POST['geheugen'] ?? ''; ?>">
                ...
                <div class="mb-3">
                    ...
                    <input name="schermgrootte" type="number" step="0.01" class="form-control <?= isset($data['errors']['schermgrootte']) ? 'is-invalid' : ''; ?>" id="schermgrootte" value="<?= $_POST['schermgrootte'] ?? ''; ?>">
                ...
                <div class="mb-3">
                    ...
                    <input name="megapixels" type="number" class="form-control <?= isset($data['errors']['megapixels']) ? 'is-invalid' : ''; ?>" id="megapixels" value="<?= $_POST['megapixels'] ?? ''; ?>">
