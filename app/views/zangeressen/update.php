        ...
        <div class="col-6">
            <form action="<?= URLROOT; ?>/ZangeressenController/update" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input name="naam" type="text" class="form-control <?= isset($data['errors']['naam']) ? 'is-invalid' : ''; ?>" id="naam"
                ...
                <div class="mb-3">
                    ...
                    <input name="waarde" type="number" class="form-control <?= isset($data['errors']['waarde']) ? 'is-invalid' : ''; ?>" id="waarde"
                        value="<?= $_POST['waarde'] ?? $data['zangeres']->NettoWaarde; ?>">
                ...
                <div class="mb-3">
                    ...
                    <input name="land" type="text" class="form-control <?= isset($data['errors']['land']) ? 'is-invalid' : ''; ?>" id="land"
                ...
                <div class="mb-3">
                    ...
                    <input name="leeftijd" type="number" class="form-control <?= isset($data['errors']['leeftijd']) ? 'is-invalid' : ''; ?>" id="leeftijd"
                ...
                <div class="mb-3">
                    ...
                    <input name="nummer" type="text" class="form-control <?= isset($data['errors']['nummer']) ? 'is-invalid' : ''; ?>" id="nummer"
                        value="<?= $_POST['nummer'] ?? $data['zangeres']->BekendsteNummer; ?>">
                ...
                <div class="mb-3">
                    ...
                    <input name="jaar" type="number" class="form-control <?= isset($data['errors']['jaar']) ? 'is-invalid' : ''; ?>" id="jaar"
                        value="<?= $_POST['jaar'] ?? $data['zangeres']->Debuutjaar; ?>">
